...
export class ReminderProcessor {
    ...
    async handleReminder(job: Job) {
        try {
            ...
            this.logger.log(`Processing ${reminderType} reminder for booking ${bookingId}`);
            ...
            console.log("job object to confirm that the patience email exist for remider (from line 22 of reminder-processor.ts in telemedicine", job.data)
            ...
            const patientEmail = job.data.patientEmail || 'patient@allofhealth.africa';
